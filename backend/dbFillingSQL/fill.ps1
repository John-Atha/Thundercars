...
Get-Content users_hashed.sql |mysql -u root db;
...
Get-Content station_owners_hashed.sql |mysql -u root db;
...
Get-Content charging_stations.sql |mysql -u root db;
...
Get-Content fix_null_operators.sql | mysql -u root db;
Get-Content station_owners2.sql |mysql -u root db;